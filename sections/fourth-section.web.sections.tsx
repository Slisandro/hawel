  ...
  const renderCard = (card: CardData) => {
    ...
    if (isPercentage) {
      return (
        <Card
          variant="glass"
          className="p-0 rounded-[32px]"
        >
          <motion.div
            key={card.id}
            className="w-full h-full bg-[#F5F5F70D] min-h-[280px] p-[24px] flex flex-col items-center justify-center shadow-md cursor-pointer bg-transparent"
    ...
    if (isTopList) {
      return (
        ...
        >
          <motion.div
            key={card.id}
            className="w-full h-full min-h-[280px] p-[24px] flex flex-col items-start md:gap-3 cursor-pointer"
            variants={cardVariants}
            whileHover="hover"
            initial="hidden"
            whileInView="visible"
    ...
    return (
      ...
      >
        <motion.div
          key={card.id}
          className="w-full h-full min-h-[280px] p-[24px] rounded-[32px] flex flex-col items-start md:gap-3 shadow-md cursor-pointer"
          variants={cardVariants}
          whileHover="hover"
          initial="hidden"
          whileInView="visible"
